...
// }).refine((data) => {
//   // Ensure either designId or customDesign is provided
...
//   // Fetch designs with proper error handling
...
//   // Extract designs from the correct path based on your actual API response
...
//   // Set pre-selected design on load
//   useEffect(() => {
...
//   // Watch for design selection changes
...
//       // This is a placeholder that simulates image upload
...
//   // Handle tab change and clear unnecessary fields
...
//                           <SelectContent>
//                             {isLoadingDesigns ? (
//                               <div className="p-2 text-center">Loading designs...</div>
//                             ) : designError ? (
...
//                             // If a design is selected, add minimum delivery time
