...
export default function ProfilePage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (data.secure_url) {
        // Update profile with new image URL using the correct field name
        updateProfile({ profileImage: data.secure_url }, {
          onSuccess: (updatedProfile) => {
            // Update the user in the store with the new profile image
            setUser({ 
              ...user, 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center space-x-3 text-sm">
              ...
              <span>{displayProfile?.email || "No email"}</span>
            </div>
            <div className="flex items-center space-x-3 text-sm">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              {displayProfile?.preferredPickupAddress ? (
                <div className="space-y-2 text-sm">
