      ...
      <section className={"bg-gray-900/80 py-16 rounded-2xl"}>
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className={`text-white text-center max-w-xl mx-auto mb-12 transition-all ease-in-out duration-150`}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className={` ${themeMode === "dark" ? "bg-white/70 text-black/80" : "bg-black/80 text-white/80"}  p-6 rounded-lg shadow-md`}
              >
